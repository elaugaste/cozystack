...
type Backup struct {
	...
	// DEPRECATED. Tenants no longer supply S3 keys; the platform-managed Bucket Secret is the source of truth.
	// +kubebuilder:default:="<your-access-key>"
	S3AccessKey string `json:"s3AccessKey"`
	// DEPRECATED. See `s3Region`.
	...
	// DEPRECATED. Per-tenant S3 configuration is being phased out in favour of the platform-managed `cozy-default` BackupClass. Kept for legacy chart-managed sidecar setups.
