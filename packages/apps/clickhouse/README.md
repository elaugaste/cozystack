...
| `backup.s3Region`                               | DEPRECATED. Per-tenant S3 configuration is being phased out in favour of the platform-managed `cozy-default` BackupClass. Kept for legacy chart-managed sidecar setups.                                                                                                                                                                                                                                      | `string` | `us-east-1`                                            |
| `backup.s3Bucket`                               | DEPRECATED. See `s3Region`.                                                                                                                                                                                                                                                                                                                                                                                  | `string` | `s3.example.org/clickhouse-backups`                    |
...
| `backup.s3AccessKey`                            | DEPRECATED. Tenants no longer supply S3 keys; the platform-managed Bucket Secret is the source of truth.                                                                                                                                                                                                                                                                                                     | `string` | `<your-access-key>`                                    |
| `backup.s3SecretKey`                            | DEPRECATED. See `s3AccessKey`.                                                                                                                                                                                                                                                                                                                                                                               | `string` | `<your-secret-key>`                                    |
